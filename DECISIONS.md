...
| D52 | 发布状态与读者入口完成分开：P1公开图源已由D49关闭；许可证、正式citation元数据和公开paper/DOI链接仍须作者提供，不代选、不伪造 | RR-03结果与RR-05授权边界 | README发布阻碍、PROVENANCE | 不创建LICENSE/CITATION.cff，不链接local PDF；文档完成不得写成正式发布完成 | 作者边界＋当前tracked状态 |
