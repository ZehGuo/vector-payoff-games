...
- Paper target: `PAPER_LINK_PENDING` — author-confirmed public DOI/version only.
...
- Paper target: `PAPER_LINK_PENDING` — relevant public paper section.
...
constructions, schematics, and numerical evidence. Public paper buttons remain
unset until the author approves DOI or version links. No local PDF should be
...
- Paper target: `PAPER_LINK_PENDING` — one or more author-confirmed public URLs.
